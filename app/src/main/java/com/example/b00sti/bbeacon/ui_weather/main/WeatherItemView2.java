...
public class WeatherItemView2 extends BaseItemView<WeatherItem> {
    ...
    protected void onAttachedToWindow() {
        ...
        lineCardOne.getMChart().invalidate();
    }

    @Override
    protected void onDetachedFromWindow() {
        lineCardOne.dismiss(null);
    ...
    public void bind(WeatherItem weatherItem) {
        ...
        lineCardOne = (new LineCardOne(card_view, context, color));
        lineCardOne.init();
        lineCardOne.getMChart().invalidate();
    }
}
